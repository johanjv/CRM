    ...
    <div :class="sidebarOpen ? 'block' : 'hidden'" @click="sidebarOpen = false" class="fixed z-20 inset-0 bg-black opacity-50 transition-opacity lg:hidden"></div>
      ...
      <header :class="sidebarOpen == false ? 'block align-top py-2' : ''">
        <div class="flex items-center">
          <button @click="sidebarOpen = true" class="text-white px-2 focus:outline-none lg:hidden bg-purple-300 rounded">
      ...
      <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform bg-purple-300 overflow-y-auto lg:translate-x-0 lg:static lg:inset-0">
         <div class="px-2 rounded-lg">
            <!-- <img src="~/static/img/logo_completo_blanco.png" alt=""> -->
            <div class="flex items-center justify-center bg-purple-300 py-2 px-2">
                <div class="flex w-full max-w-xs p-4 bg-white rounded">
                    <ul class="flex flex-col w-full">
                        ...
                        <li class="my-px">
                            <a href="#" @click.prevent="logout"
                                ...
                                <span v-if="!loadLogout" class="ml-3">Logout</span>
