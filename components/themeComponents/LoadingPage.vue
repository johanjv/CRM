<template>
    <div class="text-center justify-center" style="text-align: -webkit-center;">
        <svg class="animate-spin h-12 w-12 text-purple-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none">
